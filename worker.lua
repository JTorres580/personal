...
getgenv().petsGoConfig = {
    -- true/false
    IGNORE_FULL_CHARGE_MEGA_EGG = true,
    ...
    PICKAXE_ENCHANTS = {"Strength", "Loot", ""},
    ...
    MAIL_GEMS_MIN = 250000,  -- Minimum Gems to mail out
    ...
    USERNAME_TO_MAIL = {"JonKiwii"} -- Mail to username, Example : USERNAME_TO_MAIL = {"username1", "username2"}
}
